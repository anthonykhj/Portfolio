...
| [Income of Adults](https://github.com/anthonykhj/Income-of-Adults) | This project analyses income classification using predictive analytics on US Census data to identify key factors—such as education, age, marital status, and occupation—that influence whether an individual earns above or below $50K annually, offering insights into socioeconomic trends and earning potential. | SPSS | <ul><li>Logistic Regression</li><li>CHAID</li><li>Decision Tree</li></ul>
